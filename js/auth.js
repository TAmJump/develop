...
// ── デモ用アカウント ──
const DEMO_ACCOUNTS = [
    { email: 'demo@tamj.jp', password: 'tamj1234', name: 'デモユーザー' },
    { email: 'test@tamj.jp', password: 'test1234', name: 'テストユーザー' }
];
...
async function registerUser(email, password, displayName) {
    if (USE_DEMO) {
        ...
        DEMO_ACCOUNTS.push({ email, password, name: user.displayName });
        _currentUser = user;
