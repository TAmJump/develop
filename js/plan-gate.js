...
(function () {
    ...
    function lockProFeatures() {
        ...
        document.querySelectorAll('[data-pro="locked"]').forEach(el => {
            ...
            overlay.innerHTML = `
                <div class="pro-lock-icon"><svg viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>
    ...
    function showLimitModal(reason) {
        ...
        bg.innerHTML = `
            <div class="limit-modal">
                ...
                <div class="count">${isLimit ? used + '<small> / ' + FREE_LIMIT + ' 回</small>' : '<svg viewBox="0 0 24 24" style="width:36px;height:36px;stroke:#2d2d2d;stroke-width:1.5;fill:none;stroke-linecap:round;stroke-linejoin:round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>'}</div>
                <p>${isLimit
