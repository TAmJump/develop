...
<span style="width:1px;height:22px;background:#c9bda8;margin:0 4px"></span>
<a href="https://develop.tamjump.com/" style="text-decoration:none;font-size:13px;padding:8px 14px;border:1px solid #c9bda8;border-radius:4px;background:#fff;color:#6e6354">サイトのトップ</a>
<a href="https://develop.tamjump.com/listings/" style="text-decoration:none;font-size:13px;padding:8px 14px;border:1px solid #c9bda8;border-radius:4px;background:#fff;color:#6e6354">案件一覧</a>
<a href="https://develop.tamjump.com/members/index.html" style="text-decoration:none;font-size:13px;padding:8px 14px;border:1px solid #c9bda8;border-radius:4px;background:#fff;color:#6e6354">ツール</a>
<button onclick="location.href='/admin/signout'" style="font-size:13px;padding:8px 14px;border:1px solid #c9bda8;border-radius:4px;background:#fff;color:#6e6354;cursor:pointer">ログアウト</button></div>`;
