    ...
    function lockProFeatures() {
        ...
        document.querySelectorAll('[data-pro="locked"]').forEach(el => {
            ...
            overlay.innerHTML = `
                ...
                <a href="https://square.link/u/4Qs8fs2U" onclick="goToPayment()" class="pro-lock-btn">Proで始める →</a>
            `;
    ...
    function showLimitModal(reason) {
        ...
        bg.innerHTML = `
            <div class="limit-modal">
                ...
                <a href="https://square.link/u/4Qs8fs2U" onclick="goToPayment()" class="btn-upgrade">Proで始める — ¥300/月</a>
